...
func MyCollectsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MyCollectsReq
		if err := httpx.Parse(r, &req); err != nil {
			response.Error(r.Context(), w, errorx.ParamError, "请求参数解析失败")
			return
		}

		l := interaction.NewMyCollectsLogic(r.Context(), svcCtx)
		resp, err := l.MyCollects(&req)
		if err != nil {
