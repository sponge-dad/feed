...
func UncollectFeedHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UncollectFeedReq
		if err := httpx.Parse(r, &req); err != nil {
			response.Error(r.Context(), w, errorx.ParamError, "请求参数解析失败")
			return
		}

		l := interaction.NewUncollectFeedLogic(r.Context(), svcCtx)
		resp, err := l.UncollectFeed(&req)
		if err != nil {
