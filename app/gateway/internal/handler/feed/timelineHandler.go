...
func TimelineHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TimelineReq
		if err := httpx.Parse(r, &req); err != nil {
			response.Error(r.Context(), w, errorx.ParamError, "请求参数解析失败")
			return
		}

		l := feed.NewTimelineLogic(r.Context(), svcCtx)
		resp, err := l.Timeline(&req)
		if err != nil {
