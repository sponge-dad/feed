...
> 本文档定义所有对外 REST API 的通用约定。各模块具体接口见 [./](./) 下对应文件。

## 模块索引

| 模块 | 文档 | 业务码段 | 核心接口 |
|------|------|---------|---------|
| 用户 | [user.md](./user.md) | 10000~10999 | 注册/登录/信息/上传凭证 |
| 关系 | [relation.md](./relation.md) | 11000~11999 | 关注/取关/关注列表/粉丝列表 |
| Feed | [feed.md](./feed.md) | 12000~12999 | 发帖/删帖/详情/三种信息流 |
| 评论 | [comment.md](./comment.md) | 13000~13999 | 楼中楼评论/回复/评论点赞 |
| 互动 | [interaction.md](./interaction.md) | 14000~14999 | 帖子点赞/收藏/我的赞/我的收藏 |
