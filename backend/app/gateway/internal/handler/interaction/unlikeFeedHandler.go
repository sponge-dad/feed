...
func UnlikeFeedHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnlikeFeedReq
		if err := httpx.Parse(r, &req); err != nil {
			response.Error(r.Context(), w, errorx.ParamError, "请求参数解析失败")
			return
		}

		l := interaction.NewUnlikeFeedLogic(r.Context(), svcCtx)
		resp, err := l.UnlikeFeed(&req)
		if err != nil {
